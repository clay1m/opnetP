				...
				<table class="table table-hover">
					...
					<c:forEach items="${documents}" var="doc" varStatus="counter">
						<tr>
							...
							<td><a href="<c:url value='/view-document-${user.id}-${doc.id}' />" class="btn btn-success custom-width">view</a></td>
							<td><a href="<c:url value='/run-document-${user.id}-${doc.id}' />" class="btn btn-success custom-width">run</a></td>
