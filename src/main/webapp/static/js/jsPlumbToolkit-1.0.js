(function() {
      ...
      , o = function(a, b, c, d, f, g, h, i, j, k) {
        ...
        , v = function() {
            for (var g = 0; g < a.length; g++) {
                ...
                c[a[g][1]])
                  , y = n(t, x, d);
                h(a[g][1]) && e.intersects(p, y) && (l = m(p, y),
                o = f(a[g][1], t, l),
                u(w, t, o.left, o.top)),
                y = n(t, x, d);
    ...
    b.Magnetizer = function(a) {
        ...
        this.executeAtEvent = function(b) {
            ...
            C && (i.style.left = b.pageX + "px",
            i.style.top = b.pageY + "px"),
            this.execute([e, f])
        }
        ,
...
function() {
    ...
    var b = "undefined" != typeof navigator && /MSIE\s([\d.]+)/.test(navigator.userAgent) ? new Number(RegExp.$1) : -1
      ...
      , d = function(a, b, c) {
        ...
        this.getFunctionBody = function(b) {
            return a.compile(d(a.parse(c.template), b), !1, !0, !0)
        }
        .bind(this),
      ...
      , t = function(a, b) {
        ...
        this.compile = function(a, b) {
            if (a.customTags[this.tag]) {
                for (var c = a.customTags[this.tag].getFunctionBody(this), d = 0; d < this.children.length; d++)
                    this.children[d].precompile && (c += this.children[d].precompile(a)),
            ...
            for (var h = 0; h < this.children.length; h++)
                this.children[h].precompile && (e += this.children[h].precompile(a)),
        ...
        this.update = function(a, b) {
            for (var c in this.atts)
                if (this.atts.hasOwnProperty(c) && "class" !== c) {
                    var d;
                    d = null  != this.bindings[c] ? this.bindings[c].reapply(b) : "'" + this.atts[c] + "'",
                    null  != d && ("style" === c && null  != a.style ? e(a, d) : a.setAttribute(c, d))
                }
        }
    }
      , u = function(a) {
    ...
    C(B.prototype, {
        ...
        createFragment: function() {
            return this.isBrowser ? this.isOldIE() ? document.createElement("div") : document.createDocumentFragment() : new w
        },
        createTextNode: function(a) {
            return this.isBrowser ? document.createTextNode(a) : new y(a)
        },
        createElement: function(a) {
            return this.isBrowser ? document.createElement(a) : new x(a)
        },
        customElements: {
            "r-each": {
        ...
        parse: function(a, b) {
            ...
            var c = []
              ...
              , j = function(a, b) {
                c.length > 0 && h().children.push(a),
                b ? 0 == c.length && d.push(a) : c.push(a)
            }
              , k = function(a) {
                j(a, !0)
            }
              , l = function() {
                var a = c.pop();
                return 0 == c.length && d.push(a),
                a
            }
              , o = function(a, b, d, e) {
                var f = new t(a,e)
                  , g = e.customElements[f.tag];
                return g && (g.parse(f, b, d, e, c),
                g.compile && (f.compile = g.compile),
                f.precompile = g.precompile,
                f.postcompile = g.postcompile,
                f.custom = !0,
                f.remove = g.remove,
                e.debug("  element is a custom element"),
                e.maybeDebug(f.remove, "  element's root should not appear in output")),
                f
            }
              , p = [{
                re: f.commentRe,
                ...
                handler: function(a, b, c, d) {
                    ...
                    if (null  == e || !e.remove) {
                        if (!i(b[1]))
                            throw new TypeError("Unbalanced closing tag '" + b[1] + "'; opening tag was '" + l().tag + "'");
                        l()
                    }
                }
            }, {
            ...
            return e(m(a).split(this.tokenizerRe), function(a, c) {
                for (var d = 0; d < p.length; d++) {
                    c = m(c);
                    var e = g(c, p[d].re);
                    if (e) {
                        p[d].handler(c, e, b, this);
                        break
                    }
                }
            }
    ...
    var D = function(a) {
      ...
      , F = function(b, c) {
        c = c || "rotors";
        var d, e = (a.Rotors || a).newInstance(), f = {}, g = new RegExp("<script type=['\"]" + c + "['\"] id=['\"]([^'\"]+)['\"]>((.*\n)*?)</script>","g");
    ...
    a.RotorsInstance = B) : (a.newInstance = D,
    a.instanceClass = B,
    a.precompile = F,
    a.data = g)
}
    ...
    jsPlumb.Connection.prototype.animateOverlay = function(c, d) {
        ...
        var A = function() {
          ...
          , C = function() {
            ...
            s ? (jsPlumb.addClass(w, b.nodeTraversing),
            window.setTimeout(function() {
                jsPlumb.removeClass(w, b.nodeTraversing),
                e.removeClass(b.edgeTraversing),
                f.fire(a.end, e)
            }, n)) : (e.removeClass(b.edgeTraversing),
            f.fire(a.end, e))
        }
        ;
...
function() {
    ...
    b.Selection = function(a) {
        ...
        var d, e = a.toolkit, f = [], g = [], h = Math.Infinity, i = Math.Infinity, j = a.generator, k = {}, l = this, m = a.onClear || function() {}
        , n = function(a) {
    ...
    var c = function(a, b) {
      ...
      , g = b.Vertex = b.Node = function(a, d, g) {
        ...
        this.getAllEdges = function(a) {
            for (var b = this.getEdges(a).slice(0), c = 0; c < m.length; c++)
                b.push.apply(b, m[c].getEdges(a));
            return b
        }
        ,
        ...
        this.getIndegreeCentrality = function() {
            for (var a = 0, b = 0; b < m.length; b++)
                a += m[b].getIndegreeCentrality();
            return k + a
        }
        ,
        this.getOutdegreeCentrality = function() {
            for (var a = 0, b = 0; b < m.length; b++)
                a += m[b].getOutdegreeCentrality();
            return l + a
        }
        ,
        ...
        this.removePort = function(a) {
            if (a) {
                for (var b = p(a), c = -1, d = !1, e = 0; e < m.length; e++)
                    if (m[e].id === b) {
                        c = e;
                        break
                    }
      ...
      , j = (b.Graph = function(a) {
        ...
        this.addVertices = this.addNodes = function(a, b) {
            for (var c = 0; c < a.length; c++)
                this.addVertex(a[c], b || o)
        }
        ,
        this.deleteVertex = this.deleteNode = function(a) {
            var b = s(a);
            if (b) {
                for (var e = -1, f = 0; f < l.vertices.length; f++)
                    if (l.vertices[f].id === b.id) {
                        e = f;
                        break
                    }
        ...
        this.getDiameter = function(a) {
            for (var b = 0, c = 0; c < l.vertices.length; c++)
                for (var d = 0; d < l.vertices.length; d++)
                    if (d != c) {
                        var e = n.compute({
                            graph: l,
                            source: l.vertices[c],
        ...
        ,
        this.inspect = function() {
            for (var a = "", b = 0; b < l.vertices.length; b++)
                a += l.vertices[b].inspect() + "\n";
            return a
        }
        ,
        ...
        compute: function(a) {
            ...
            ; F < r.length; ) {
                ...
                if (!H.node || u(H.node) == 1 / 0)
                    break;
                if (d && (I == q(d) || !p && H.node.isChildOf && H.node.isChildOf(d)) && (k.path = l(g, h, i, d, q),
                k.pathDistance = k.path[k.path.length - 1].cost,
                !m))
                    break;
                E[H.index] = !0,
                F += 1,
...
function() {
    ...
    a.jsPlumbToolkitInstance = function(g) {
        ...
        var h = g.idFunction || f
          ...
          , l = g.typeFunction || function(a) {
            return a[i] || e
        }
          , m = g.edgeIdFunction || h
          , n = g.edgeTypeFunction || function(a) {
            return a[j] || e
        }
          , o = g.portIdFunction || h
          , p = g.portTypeFunction || function(a) {
            return a[k] || e
        }
          , q = g.portExtractor
          , r = this
          ...
          , A = g.saveUrl
          , B = g.onAutoSaveSuccess || function() {}
          , C = g.onAutoSaveError || function() {}
        ...
        this.beforeStartConnect = g.beforeStartConnect || function(a, b) {
            return {}
        }
        ,
        this.beforeDetach = g.beforeDetach || function(a, b, c) {
            return !0
        }
        ,
        this.beforeStartDetach = g.beforeStartDetach || function(a, b) {
            return !0
        }
        ,
        ...
        this.eachNode = function(a) {
            for (var b = 0, c = F.getVertexCount(); c > b; b++)
                a(b, F.getVertexAt(b))
        }
        ,
        this.eachEdge = function(a) {
            for (var b = F.getEdges(), c = 0, d = b.length; d > c; c++)
                a(c, b[c])
        }
        ,
        this.getEdgeCount = function() {
        ...
        this.exists = function(a) {
            for (var b = 0; b < arguments.length; b++)
                if (null  == F.getVertex(arguments[b]))
                    return !1;
            return !0
        }
        ,
        ...
        this.removeEdge = function(b, c) {
            ...
            null  != b && (F.deleteEdge(b),
            O || D || a.jsPlumbToolkitIO.manage("removeEdge", M, N, b, m || F.getIdFunction(), r),
            r.fire("edgeRemoved", {
                edge: b,
                source: c
            }, null )),
                ...
                try {
                    if (!b.obj || "Node" != b.type && "Edge" != b.type) {
                        for (; a.getNodeCount() > 0; )
                            r.removeNode(a.get(0));
                        for (; a.getEdgeCount() > 0; )
                            r.removeEdge(a.getEdge(0))
                    } else
                        r["remove" + b.type](b.obj)
                } finally {
                ...
                if (null  != d)
                    for (var i = d[b]({
                        ...
                        var k = e && d == F || i[j].source == d || c && i[j].source.constructor == jsPlumbGraph.Port && i[j].source.getNode() == d
                          , l = g && d == F || i[j].target == d || c && i[j].target.constructor == jsPlumbGraph.Port && i[j].target.getNode() == d;
                        (e && k || g && l || h && (k || l)) && f(i[j])
                    }
            }
            ;
        ...
        this.getObjectInfo = function(a, b) {
            var c = {
              ...
              , e = function(a) {
                var b = {};
                for (var c in W)
                    b[c] = [W[c], W[c].getRenderedElement(a)];
                return b
            }
            ;
            if (null  != a) {
                ...
                if (null  != f && f.jtk)
                    ...
                    var g = d(f);
                    null  != g && (c.el = g,
                    c.obj = g.jtk.port || g.jtk.node)
                } else {
                    if ("string" == typeof a && (a = this.getNode(a)),
                    null  == a)
                        return c;
                    c.obj = a,
                    null  != b && (c.el = b(a))
                ...
                null  != c.obj && (c.id = c.obj.id,
                c.type = c.obj.objectType)
            }
            return c
        }
        ,
...
function() {
    ...
    c.AbstractLayout = function(b) {
        ...
        var C = function(a, b) {
          ...
          , F = this.setPosition = function(a, b, d, e) {
            var f = o[a];
            f ? (f[0] = parseFloat(b),
            f[1] = parseFloat(d)) : (f = o[a] = [parseFloat(b), parseFloat(d)],
            p.push([f, a])),
            E(f),
        ...
        .bind(this)
          , J = this.draw = function(a) {
            for (var b in o) {
                var d = I(b);
                null  != d && (q = Math.min(d[0], q),
                r = Math.min(d[1], r),
                s = Math.max(d[0] + d[2], s),
                t = Math.max(d[1] + d[3], t))
            }
    ...
    var h = c.AbstractHierarchicalLayout = function(a) {
        ...
        return b.begin = function(b, c) {
            ...
            c.getRootNode = c.getRootNode || function(a) {
        ...
        this.step = function(a, b) {
            ...
            , o = 0; o < n.length; o++) {
                ...
                for (var q = 0; q < n[o].nodes.length; q++)
                    f = 0 == e ? n[o].nodes[q].loc : j(n[o].nodes[q], i),
    ...
    var k = function(a, b) {
      ...
      , q = b.AbstractRenderer = function(b) {
        ...
        var D = [j.canvasClick, j.canvasDblClick, j.nodeAdded, j.nodeDropped, j.nodeRemoved, j.nodeRendered, j.nodeMoveStart, j.nodeMoveEnd, j.portAdded, j.portRemoved, j.edgeAdded, j.edgeRemoved, j.edgeTypeChanged, j.nodeTypeChanged, j.portTypeChanged, j.dataLoadEnd, j.anchorChanged, j.objectRepainted, j.modeChanged, j.pan, j.zoom, j.relayout, j.click, j.tap, j.stateRestored, j.startOverlayAnimation, j.endOverlayAnimation]
          , E = i.bind
          , F = B.bind;
        if (this.setHoverSuspended = B.setHoverSuspended,
        this.isHoverSuspended = B.isHoverSuspended,
        ...
        if (this.bindToolkitEvents !== !1) {
            ...
            .bind(this)),
            l.bind(j.dataAppendEnd, function() {
                this.setSuspendRendering(!1),
                W(),
                i.refresh(),
                B.setSuspendDrawing(!1, !0),
            ...
            l.bind(j.edgeRemoved, function(a) {
                if (!I && a.source !== i) {
                    var b = a.edge
                      , c = P[b.getId()];
                    c && (l.isDebugEnabled() && console.log("Renderer", "removing edge", b),
                    U(c, b),
                    B.detach({
            ...
            l.bind(j.edgeTarget, function(a) {
                if (!I) {
                    ...
                    c ? B.silently(function() {
                        null  != d ? (l.isDebugEnabled() && console.log("target change", c),
                        B.setTarget(c, d)) : (delete P[b.getId()],
                        B.detach({
                            connection: c,
                            forceDetach: !0,
                            fireEvent: !1
            ...
            l.bind(j.edgeSource, function(a) {
                if (!I) {
                    ...
                    c ? B.silently(function() {
                        null  != d ? B.setSource(c, d) : (delete P[b.getId()],
                        B.detach({
                            connection: c,
                            forceDetach: !0,
                            fireEvent: !1
            ...
            l.bind(j.portUpdated, function(a) {
                ...
                b && ("undefined" != typeof Rotors && o.update(b, a.port.data),
                i.repaint(J[a.node.id]))
            }),
        ...
        this.deactivateState = function(a, b) {
            ...
            c && (b = ba(b),
            c.deactivate(b, i, l),
            jsPlumbUtil.removeWithFunction(aa, function(a) {
                return a == c
            }))
        }
        ,
        ...
        var ca = function(a) {
          ...
          , da = function(a, b, c, d, e, f, g, h) {
            return function(i, j, k) {
                ...
                if (w) {
                    t = jsPlumb.extend({}, q ? q.parameters || {} : {}),
                    jsPlumb.extend(t, j);
                    var u = {};
                    for (m in t)
        ...
        var ga = function(b) {
            ...
            if (c.jsPlumbToolkit = l,
            c.adapter = i,
            !a.jsPlumbToolkit.Layouts[c.type])
        ...
        var ha = {}
          ...
          , ja = function(a, b, c) {
            ...
            if (p.connectionType = s,
            p.portId = f,
            p.portType = g,
            p.scope = h,
            p.parameters = p.parameters || {},
            p.parameters.portId = f,
            p.parameters.portType = g,
            p.parameters.edgeType = s,
            p.parameters.scope = h,
            p.parameters.nodeId = c,
            p.events = {},
            o.events)
                for (v in o.events)
                ...
                for (e = 0; e < a.childNodes.length; e++)
                    if (3 != a.childNodes[e].nodeType && 8 != a.childNodes[e].nodeType) {
                        ...
                        if (a.childNodes[e].tagName.toUpperCase() == g.SOURCE && null  == a.childNodes[e].getAttribute("jtk-processed")) {
                            ...
                            if (null  != f.portId && (ia.source[c + "." + f.portId] = a,
                            a.jtk = a.jtk || {},
                            ...
                            a.childNodes[e].setAttribute("jtk-processed", !0),
                            "undefined" != typeof Rotors && o.onUpdate(a, function(a, d) {
                                var e = jsPlumb.getSelector(a, "jtk-source");
                                if (1 == e.length) {
                                    var f = ja(e[0], b, c);
                                    f.scope && (B.setSourceScope(a, f.scope, f.edgeType),
                                    s && s.k.setDropScope(s, f.scope))
                                }
                            })
                        }
                        if (a.childNodes[e].tagName.toUpperCase() == g.TARGET && null  == a.childNodes[e].getAttribute("jtk-processed")) {
                            f = ja(a.childNodes[e], b, c),
                            0 != d && (ia.target[c + "." + f.portId] = a,
                            a.jtk = a.jtk || {},
                            a.jtk.port = l.addPort(b, {
                                id: f.portId
                            }, !0)),
                            ...
                            "undefined" != typeof Rotors && o.onUpdate(a, function(a, d) {
                                ...
                                if (1 == e.length) {
                                    var f = ja(e[0], b, c);
                                    f.scope && (v.targetDef.def.scope = f.scope,
                                    v.k.setDropScope(v, f.scope))
                                }
                            })
                        }
        ...
        this.storePositionInModel = function(a) {
            var b = "string" == typeof a ? a : a.id
              ...
              , e = p.getPosition(b)
              , f = l.getNode(b);
            return f && (Rotors.data(f.data, c, e[0]),
            Rotors.data(f.data, d, e[1])),
            e
        }
        ;
        var la = function(a, b, c, d, e, f, g) {
            return a = a || ma(b),
            a && (p.setPosition(a.id, c, d),
            e || (B.setAbsolutePosition(a.el, [c, d], f, g),
            B.revalidate(a.el))),
            a
        }
        ;
        ...
        this.setVisible = function(a, b, c) {
            if (null  != a) {
                var d = function(a) {
                    var d = Q(a);
                    d && d.setVisible(b),
                    c || (d.endpoints[0].setVisible(b),
                    d.endpoints[1].setVisible(b))
                }
                  , e = function(a, e) {
                    if (e && (e.style.display = b ? "block" : "none",
                    !c))
...
function() {
    ...
    var a = this
      ...
      , g = function(a, b) {
        return function(c) {
            b && null  != c.mozInputSource && 1 !== c.mozInputSource || (c.normalizedWheelDelta = f(c),
            a(c))
        }
    }
...
function() {
    ...
    this.ZoomWidget = function(b) {
        ...
        var Aa = function(a, b, c) {
          ...
          , Na = function(a, c, d) {
            if (z || T || U) {
                ...
                g && (q[0] = Math.max(q[0], g.getWidth()),
                q[1] = Math.max(q[1], g.getHeight()));
                var r = a + f[0] + q[0] * $ - d
                  , t = c + f[1] + q[1] * $ - d
                  , u = a + f[0] + j.x * $ + d
                  , v = c + f[1] + j.y * $ + d;
          ...
          , Ra = {
            start: function(a, c) {
                if (!ba) {
                    ...
                    S && (d == q || d == s || d._jtkDecoration || g && g.owns(d) || V(d, a) === !0) && (da = !1,
                    ga = -1,
                    ha = -1,
                    3 !== a.which || b.enableWheelZoom === !1 || null  != a.mozInputSource && 1 !== a.mozInputSource ? c.length <= 1 && (aa = !0,
                    h = Ha(a),
                    l = Oa(q)) : (ca = !0,
                    h = Ha(a),
                    Fa(a),
        ...
        ;
        if (Q(r, M, Wa),
        Q(r, "contextmenu", function(a) {
            Sa("contextmenu", a)
        }),
        D) {
            var Xa = function(a) {
                F(a) && (a.preventDefault && a.preventDefault(),
                a.stopPropagation && a.stopPropagation(),
                i = $,
                da || (Fa(a),
                da = !0),
                La(0, a.normalizedWheelDelta * G, a, !0))
            }
            ;
        ...
        this.setZoomRange = function(a, b) {
            return null  != a && 2 == a.length && a[0] < a[1] && null  != a[0] && null  != a[1] && a[0] > 0 && a[1] > 0 && (ea = a,
            b || ($ < ea[0] || $ > ea[1]) && Ka($)),
            this
        }
        ,
    ...
    c.Surface = function(a) {
        ...
        var n, o = d.getElement(a.container), p = c.createElement({
            ...
            onSelect: function(a, b, c, d) {
                ...
                for (var g = 0; g < f.length; g++)
                    (null  == A || A(f[g].el.jtk.node) !== !1) && (e.push(f[g].el.jtk.node),
                    m.jsPlumb.addToDragSelection && m.jsPlumb.addToDragSelection(f[g].el));
                z = e,
        ...
        m.toolkit.bind(h.select, function(a) {
            if (a.obj.objectType == h.nodeType) {
                ...
                b && (jsPlumb.addClass(b, g.SURFACE_SELECTED_ELEMENT),
        ...
        m.toolkit.bind(i.deselect, function(a) {
            if (a.obj.objectType == h.nodeType) {
                var b = m.getElement(a.obj.id);
                b && (jsPlumb.removeClass(b, g.SURFACE_SELECTED_ELEMENT),
        ...
        var R = function(a) {
            ...
            , n = a.droppables ? a.droppables : a.source ? a.source.querySelectorAll(a.selector) : [], p = a.dragOptions || {}, q = a.dropOptions || {}, r = "scope_" + (new Date).getTime(), s = function(b, c, d) {
                ...
                e) {
                    ...
                    null  != n && (o.type = n),
                    k(i.left, i.top, o),
                    m.toolkit.getNodeFactory()(n, o, function(c) {
            ...
            , t = d.dragEvents[h.start], u = d.dragEvents[h.drag], v = d.dragEvents[h.stop], w = d.dragEvents[h.drop], x = function() {}
            , z = a.nativeFilter || [], A = a.allowNative, B = {};
            ...
            A) {
                ...
                document.addEventListener(i.dragover, function(a) {
                    a.stopPropagation(),
                    a.preventDefault(),
                    D(a) && (jsPlumb.setAbsolutePosition(C, [a.pageX, a.pageY]),
                    p[u].apply(null , [a, {
                        helper: C,
                        offset: {
                            left: a.pageX,
...
function() {
    ...
    c.Miniview = function(a) {
        ...
        u && (v = jsPlumb.createElement("div"),
        v.className = f.MINIVIEW_COLLAPSE,
        p.appendChild(v),
        e.on(v, g.click, function(a) {
            w = !w,
...
function() {
    ...
    var a = this
      ...
      , c = b.Widgets
      , d = jsPlumbUtil
      , e = (/MSIE\s([\d.]+)/.test(navigator.userAgent) && new Number(RegExp.$1) < 9,
    ...
    c.Lasso = function(a) {
        var b = a.canvas
          ...
          , o = function(b) {
            ...
            a.on(document, g, q),
            a.on(document, h, p),
            a.on(document, "onselectstart", r),
            j = a.pageLocation(b),
            jsPlumb.setAbsolutePosition(e, j),
            i(e, [1, 1]),
          ...
          , p = function(b) {
            if (n) {
                ...
                [j[0] < c[0], j[1] < c[1]];
                jsPlumb.setAbsolutePosition(e, g),
                i(e, f),
                m(g, f, [j[0] < c[0], j[1] < c[1]], b.shiftKey)
            }
        }
          , q = function(b) {
            n && (n = !1,
            ...
            a.off(document, g, q),
            a.off(document, h, p),
            a.off(document, "onselectstart", r),
    ...
    var v = function() {
      ...
      , A = function(a) {
        if (a.id && o[a.id]) {
            ...
            u && (jsPlumb.on(window, "resize", x),
            jsPlumb.on(window, "scroll", x)),
            jsPlumb.on(c, "click", "[jtk-clear]", function(a) {
      ...
      , B = function(a) {
        for (var b = e.querySelectorAll("[jtk-att]"), c = 0; c < b.length; c++) {
            var d = b[c].tagName.toUpperCase()
              ...
              , h = s.data(a, g);
            null  != h && C[f](b[c], h),
            b[c].getAttribute("jtk-commit") && ("INPUT" === d ? jsPlumb.on(b[c], "keyup", function(a) {
      ...
      , G = function() {
        for (var a = e.querySelectorAll("[jtk-att]"), b = {}, c = 0; c < a.length; c++) {
            ...
            if (null  != g) {
                var i = s.data(b, h);
                null  != i ? (jsPlumbUtil.isArray(i) || s.data(b, h, [i]),
                i.push(g)) : s.data(b, h, g)
            }
        }
        return b
    }
      ...
      , I = function(d) {
        ...
        jsPlumb.off(document, "keyup", y),
        jsPlumb.off(window, "resize", x),
        jsPlumb.off(window, "scroll", x),
        jsPlumb.removeClass(c, "jtk-dialog-overlay-visible"),
        jsPlumb.removeClass(c, "jtk-dialog-overlay-top"),
        jsPlumb.removeClass(c, "jtk-dialog-overlay-bottom"),
        jsPlumb.removeClass(c, "jtk-dialog-overlay-left"),
        jsPlumb.removeClass(c, "jtk-dialog-overlay-right"),
        jsPlumb.removeClass(c, "jtk-dialog-overlay-x"),
        jsPlumb.removeClass(c, "jtk-dialog-overlay-y"),
    ...
    a.jsPlumbToolkit.DrawingTools = function(a) {
        ...
        var z = function(a) {
          ...
          , A = function(a) {
            ...
            m.removeClass(document.body, "jtk-draw-select-defeat"),
        ...
        m.on(document, "mousedown", ".jtk-draw-handle", function(a) {
            ...
            j = i + q.h,
            e = y[o],
            m.addClass(document.body, "jtk-draw-select-defeat"),
