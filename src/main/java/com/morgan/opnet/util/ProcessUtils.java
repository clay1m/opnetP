...
public class ProcessUtils {
	...
	public static void runSystemCommand(SystemCommand systemCommand) {
		...
		executor.setWorkingDirectory(workingDirectory != null ? workingDirectory : TempDirUtils.getTempDirectory());
		systemCommand.setCommandRun(commandRun);
	...
	public static ProcessResponse runProcess(List<String> command, Map<String, String> envVars, File workingDir)
			throws IOException {

		// create the process including environment variables and working
		// directory
